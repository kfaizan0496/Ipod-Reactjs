...
import sound from "./assets/music/Kitni Haseen Hogi.mp3";
  ...
  rotateWheel = () => {
    ...
    if (self.state.enter < 2) {
      activeRegion.bind(containerElement, "rotate", function (event) {
        ...
        console.log("angle checking", newAngle);
          ...
          <div style={styles.buttonContainer}>
            <div style={styles.menuButton}>
              ...
              <i
                ...
                style={(styles.image, styles.blackColor)}
...
const styles = {
  ipodContainer: {
    height: "33rem",
    width: "20rem",
    backgroundImage: "radial-gradient(#18559e,#222277)",
    margin: "4rem auto",
    display: "flex",
    flexDirection: "row",
    flexWrap: "wrap",
