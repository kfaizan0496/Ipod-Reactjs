      ...
      <div style={styles.myMusicContainer}>
        <div style={styles.titleBar}>
          ...
          <img
            ...
            src="https://cdn-icons-png.flaticon.com/512/3103/3103457.png"
          ></img>
        </div>
        ...
        <div style={styles.info}>
          <img
            style={styles.image}
            src="https://pbs.twimg.com/media/FWWX5nNUcAAISV-?format=jpg&name=900x900"
          ></img>
          <div style={styles.subInfo}>
            <h4 style={{ marginBottom: "0.5rem" }}>Kitni Haseen Hogi</h4>
            <p style={{ marginBottom: "0" }}>Arijit Singh</p>
            <p>Shawn Mendes</p>
          </div>
        </div>
